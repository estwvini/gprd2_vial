...
<div class="modal-content" id="ditch_create">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">×</span>
        </button>
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('ditch.labels.create') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('store.create.ditch.inventory_roads') }}"
                  method="post"
                  class="form-horizontal form-label-left" id="ditch_create_fm">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            <option value="">{{ trans('app.labels.select') }}</option>
                            @foreach($typeDitches as $typeDitche)
                                <option value="{{ $typeDitche->descrip }}">
                                    {{ $typeDitche->descrip }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="lati" id="lati"
                               ...
                               placeholder="{{ trans('ditch.placeholders.lati') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="longi" id="longi"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('ditch.placeholders.longi') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="latf" id="latf"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('ditch.placeholders.latf') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="longf" id="longf"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('ditch.placeholders.longf') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('ditch.placeholders.observ') }}"></textarea>
                    </div>
                </div>
