...
<div class="modal-content" id="intersection_create">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('shape.labels.create') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('store.create.shape.inventory_roads') }}"
                  method="post"
                  class="form-horizontal form-label-left" id="shape_create_fm">
                @csrf
