@permission('edit.inventory_roads')
...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-automobile"></i> {{ trans('general_characteristics_of_track.labels.edit') }}</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.inventory_roads', ['code' => $entity->codigo]) }}"
                          method="post"
                          class="form-horizontal form-label-left" id="general_characteristic_of_track_update_fm">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <select class="form-control select2"
                                    ...
                                    @foreach($typeInterconnections as $typeInterconnection)
                                        <option value="{{ $typeInterconnection->descrip }}" @if($entity->tipointer == $typeInterconnection->descrip) selected @endif>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="altermat" id="altermat" class="js-switch"
                                       @if(strtoupper($entity->altermat) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="planttr" id="planttr" class="js-switch"
                                       @if(strtoupper($entity->planttr) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="relleno" id="relleno" class="js-switch"
                                       @if(strtoupper($entity->relleno) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="proysoc" id="proysoc" class="js-switch"
                                       @if(strtoupper($entity->proysoc) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="proyest" id="proyest" class="js-switch"
                                       @if(strtoupper($entity->proyest) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="proyseg" id="proyseg" class="js-switch"
                                       @if(strtoupper($entity->proyseg) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <input type="checkbox" name="proypro" id="proypro" class="js-switch"
                                       @if(strtoupper($entity->proypro) == $GeneralCharacteristicsOfTrack::STATUS_TRUE) checked @endif/>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-12">
                                <select class="form-control select2"
                                    ...
                                    @foreach($climaticConditions as $climaticCondition)
                                        <option value="{{ $climaticCondition->descrip }}" @if($entity->coclimati == $climaticCondition->descrip) selected @endif>
...
<script>
    $(() => {
        ...
        let $form = $('#general_characteristic_of_track_update_fm');
