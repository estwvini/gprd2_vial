...
<div class="modal-content" id="signal_horizontal_create">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">×</span>
        </button>
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('signal_horizontal.labels.create') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('store.create.signal_horizontal.inventory_roads') }}"
                  method="post"
                  class="form-horizontal form-label-left" id="signal_horizontal_create_fm">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('signal_horizontal.placeholders.observ') }}"></textarea>
                    </div>
                </div>
...
<script>
    $(() => {
        ...
        let $form = $('#signal_horizontal_create_fm');
