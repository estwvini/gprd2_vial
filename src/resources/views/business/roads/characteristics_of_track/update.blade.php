@permission('edit.characteristics_of_track.inventory_roads')
...
<div class="modal-content" id="intersection_create">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('characteristics_of_track.labels.edit') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form"
                  action="{{ route('update.edit.characteristics_of_track.inventory_roads', ['gid' => $entity->gid]) }}"
                  method="post"
                  class="form-horizontal form-label-left" id="characteristics_of_track_update_fm">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2 select2_tipoterreno" id="tipoterreno" name="tipoterreno"
                            ...
                            @foreach($typeOfLands as $typeOfLand)
                                <option value="{{ $typeOfLand->descrip }}"
                                        @if($entity->tipoterreno == $typeOfLand->descrip) selected @endif>
                                    {{ $typeOfLand->descrip }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($roundSurfaceTypes as $roundSurfaceType)
                                <option value="{{ $roundSurfaceType->descrip }}"
                                        @if($entity->tsuperf == $roundSurfaceType->descrip) selected @endif>
                                    {{ $roundSurfaceType->descrip }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descrip }}"
                                        @if($entity->esuperf == $state->descrip) selected @endif>
                                    {{ $state->descrip}}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($useRoads as $useRoad)
                                <option value="{{ $useRoad->descrip }}"
                                        @if($entity->uso == $useRoad->descrip) selected @endif>
                                    {{ $useRoad->descrip }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($lanes as $lane)
                                <option value="{{ $lane->descrip }}"
                                        @if($entity->carriles == $lane->descrip) selected @endif>
                                    {{ $lane->descrip }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descrip }}"
                                        @if($entity->esenhori == $state->descrip) selected @endif>
                                    {{ $state->descrip }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descrip }}"
                                        @if($entity->esenvert == $state->descrip) selected @endif>
                                    {{ $state->descrip }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('characteristics_of_track.placeholders.observ') }}">{{ $entity->observ }}</textarea>
                    </div>
                </div>
...
<script>
    $(() => {
        ...
        let $form = $('#characteristics_of_track_update_fm');
